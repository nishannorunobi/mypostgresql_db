#!/bin/bash
# reset_db.sh — DROP and fully recreate the myodoo database. DEV ONLY.
# All data is destroyed. Re-initialize Odoo (web wizard or -i base) afterwards.
set -euo pipefail
...
echo ""
warn "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
warn "  This will DROP database '$ODOO_DB'."
