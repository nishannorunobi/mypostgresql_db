#!/bin/bash
# cleandb.sh — DROP the myodoo database and the odoo role completely. Clean slate.
...
echo ""
warn "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
warn "  DROP database '$ODOO_DB' and role '$ODOO_USER'"
...
info "Terminating active connections to '$ODOO_DB'..."
$PSQL_SUPER -c \
    "SELECT pg_terminate_backend(pid)
     FROM pg_stat_activity
     WHERE datname = '$ODOO_DB' AND pid <> pg_backend_pid();" -q

info "Dropping database '$ODOO_DB'..."
$PSQL_SUPER -c "DROP DATABASE IF EXISTS \"$ODOO_DB\";" -q
success "Database '$ODOO_DB' dropped."

info "Dropping role '$ODOO_USER'..."
$PSQL_SUPER -c "DROP ROLE IF EXISTS \"$ODOO_USER\";" -q
success "Role '$ODOO_USER' dropped."
